...
Junior Backend Software Engineer focused on building reliable backend systems with Python and an interest in financial technology.

🛠️ Tech

Backend: Python · FastAPI · Pydantic
Data & Databases: PostgreSQL · SQL · Pandas · NumPy
Engineering: Docker · Linux · Git · pytest
Currently learning: Java · Spring Boot

💻 What I'm working on

I'm building backend projects around market data, trading-support workflows and financial systems, with a focus on APIs, data validation, databases and testing.
